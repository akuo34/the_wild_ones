...
module.exports = {
  ...
  postAbout: (portraitFireBaseUrl, bio, portraitFilename, bannerFireBaseUrl, bannerFilename, cvFireBaseUrl, cvFilename) => AboutItem.create({ portraitFireBaseUrl, bio, portraitFilename, bannerFireBaseUrl, bannerFilename, cvFireBaseUrl, cvFilename }),
  ...
  putAboutCV: (cvFireBaseUrl, cvFilename, _id) => AboutItem.findOneAndUpdate({ _id }, { cvFireBaseUrl, cvFilename }),
